...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="${pageContext.request.contextPath}/totoken"><span class="glyphicon glyphicon-stats"></span> 令牌管理</a></li>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
									...
									<button type="button" id="confirmDel" class="btn btn-primary" onclick="deleteToken()">确定</button>
								</div>
							</div>
						</div>
					</div>
							...
							<div class="modal-content">
								...
								<div class="modal-body">
									<div id="add-info" class="input-group">
										<input class="form-control" type="text"  name="token" id="token" value="" placeholder="令牌号"/>
										<input class="form-control" type="text" name="userid" id="userid" value="" placeholder="用户id号"/>
									</div>
								</div>
								<div class="modal-footer">
									<button type="button" class="btn btn-primary" data-dismiss="modal">取消</button>
									<button type="button" class="btn btn-primary" onclick="addToken()" data-dismiss="modal">添加</button>
								</div>
							</div>
						</div>
					</div>
							...
							<div class="modal-content">
								...
								<div class="modal-body">
									<div id="update-info" class="input-group">
										<span>token:</span><input class="form-control" type="text"  name="token" id="token" value="" />
										</br><span>userId:</span><input class="form-control" type="text" name="userid" id="userid" value="" />
										</br><span>ID:</span><input class="form-control" type="text" name="tokenid" id="tokenid" value="" disabled="disabled"/>
									</div>
								</div>
								<div class="modal-footer">
									<button type="button" class="btn btn-primary" data-dismiss="modal">取消</button>
									<button type="button" class="btn btn-primary" onclick="updateToken()" data-dismiss="modal">修改</button>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="panel-body">
						<table data-toggle="table" id="table" data-url="querry?type=token" data-single-select="true" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
						    <thead>
						    <tr>
						       <th data-field="state" data-checkbox="true" >选择</th>
						        <th data-field="tokenId" data-sortable="true">ID</th>
						        <th data-field="token"  data-sortable="true">令牌号</th>
