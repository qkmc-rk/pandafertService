...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="${pageContext.request.contextPath}/torecord"><span class="glyphicon glyphicon-pencil"></span> 已完成订单管理</a></li>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
									...
									<button type="button" id="confirmDel" class="btn btn-primary" onclick="deleteRecord()">确定</button>
								</div>
							</div>
						</div>
					</div>
							...
							<div class="modal-content">
								...
								<div class="modal-body">
									<div id="add-info" class="input-group">
										<input class="form-control" type="text"  name="recordnumber" id="recordnumber" value="" placeholder="订单号"/>
										<input class="form-control" type="text" name="result" id="result" value="" placeholder="结果"/>
								...
								<div class="modal-footer">
									...
									<button type="button" class="btn btn-primary" onclick="addRecord()" data-dismiss="modal">添加</button>
								</div>
							</div>
						</div>
					</div>
							...
							<div class="modal-content">
								...
								<div class="modal-body">
									<div id="update-info" class="input-group">
										<span>完成时间:</span><input class="form-control" type="text" name="cretime" id="cretime" value="" disabled="disabled"/>
										</br><span>订单号:</span><input class="form-control" type="text"  name="recordnumber" id="recordnumber" value="" />
										</br><span>结果:</span><input class="form-control" type="text" name="result" id="result" value="" />
								...
								<div class="modal-footer">
									<button type="button" class="btn btn-primary" data-dismiss="modal">取消</button>
									<button type="button" class="btn btn-primary" onclick="updateRecord()" data-dismiss="modal">修改</button>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="panel-body">
						<table id="table" data-toggle="table" data-url="querry?type=record" data-single-select="true" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
						    <thead>
						    <tr>
						        <th data-field="state" data-checkbox="true" >选择</th>
						        <th data-field="recordId" data-sortable="true">ID</th>
						        <th data-field="finishTime"  data-sortable="true">完成时间</th>
						        <th data-field="recordNumber" data-sortable="true">订单号</th>
						        <th data-field="result" data-sortable="true">处理结果</th>
